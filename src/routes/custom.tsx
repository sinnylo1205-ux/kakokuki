...
export const Route = createFileRoute("/custom")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "KAKO KUKI 企業禮贈品客製化服務，含封套客製、籤詩印製與大量訂製，並提供線上訂購詢價問卷。",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[1400px] px-6 pb-24 md:px-10">
        ...
        <section className="grid items-center gap-12 pt-14 md:grid-cols-2 md:pt-20">
          <div>
            ...
            <h2 className="mt-8 text-sm leading-loose tracking-[0.12em] text-muted-foreground">
              從封套、籤詩到外袋印製，KAKO KUKI 為企業打造專屬的節慶禮贈方案， 讓每一份贈禮都替品牌說話。
            </h2>
            <a
              href="#enquiry"
        ...
        <section className="mt-24 border-t border-gold-soft pt-16">
          <p className="text-center text-xs tracking-[0.35em] text-muted-foreground">為 什 麼 選 擇 我 們</p>
          <h2 className="mt-5 text-center text-2xl tracking-[0.16em] md:text-3xl">好吃之外，再多一點令人記得的理由</h2>
          <div className="mt-14 grid gap-8 md:grid-cols-3">
            {reasons.map((r) => (
              ...
              >
                ...
                <p className="mt-4 text-sm leading-loose tracking-[0.06em] text-muted-foreground">{r.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-24 border-t border-gold-soft pt-16">
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
            {["聯名一", "聯名二", "聯名三", "聯名四", "聯名五", "聯名六", "聯名七", "聯名八"].map((n) => (
                ...
                {nodes.map((n) => (
                  <li key={n.title} className="flex gap-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-3 text-sm leading-loose tracking-[0.06em] text-muted-foreground">{n.body}</p>
